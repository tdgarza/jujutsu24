...
<body>
    ...
    <form method="post" action="procesarelformulario.php">
        ...
        <input type="date" name="fechadecreacion" requiered>
        <label for="descripción">Descripcion del Superheroe: </label>
        <textarea name="descripción" requiered></textarea><br>
